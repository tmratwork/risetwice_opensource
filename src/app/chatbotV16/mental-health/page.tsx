...
export default function MentalHealthV15Page() {
  ...
  const startQuest = async (questId: string) => {
    ...
    try {
      ...
      // Navigate to the V15 chatbot page instead of V11
  ...
  const fetchInsights = async () => {
    ...
    try {
      ...
      // console.error('Error fetching insights:', _err);
  ...
  const fetchUserProfile = async () => {
    ...
    try {
      ...
      // console.error('Error fetching user profile:', _err);
  ...
  const handlePrivacySettingsChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // console.error('Error updating privacy settings:', _err);
      setInsightsError(err instanceof Error ? err.message : String(err));
    }
  };
  ...
  const generateInsights = async () => {
    ...
    try {
      ...
      // console.error('Error generating insights:', _err);
      setInsightsError(err instanceof Error ? err.message : String(err));
      setAnalyzing(false);
    }
  };
  ...
  const pollJobStatus = async (id: string) => {
    try {
      ...
      // console.error('Error polling job status:', _err);
    }
  };
  ...
  const refreshUserProfile = async () => {
    ...
    try {
      ...
      // console.error('Error refreshing user profile:', _err);
  ...
  const pollProfileJobStatus = async (id: string) => {
    try {
      ...
      // console.error('Error polling profile job status:', _err);
    }
  };
  ...
  const clearUserProfile = async () => {
    ...
    try {
      ...
      // console.error('Error clearing user profile:', _err);
      setProfileError(err instanceof Error ? err.message : String(err));
    } finally {
                            ...
                            <button
                              onClick={async (e) => {
                                ...
                                try {
                                  ...
                                  // console.error('Error generating summary sheet:', _err);
                                  setInsightsError(err instanceof Error ? err.message : String(err));
                                  setAnalyzing(false);
                                }
                              }}
