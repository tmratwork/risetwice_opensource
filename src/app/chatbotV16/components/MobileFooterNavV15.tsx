      ...
      */}
      ...
      <div className="relative">
        <button
          ...
          className="flex flex-col items-center text-xs text-sage-400 dark:text-gray-400 hover:text-sage-500 dark:hover:text-white"
          aria-label="Menu"
        >
        ...
        {isMenuOpen && (
          <>
            ...
            {/* Menu */}
            <div className="absolute bottom-full right-0 mb-2 bg-sage-200 dark:bg-[#1a1a1b] border border-sage-400 dark:border-gray-700 rounded-lg shadow-lg min-w-[140px] z-50">
              <div className="py-1">
                {/* Light Mode / Dark Mode Toggle */}
                <div className="px-4 py-2 hover:bg-sage-300 dark:hover:bg-gray-700 cursor-pointer" onClick={() => {
                  setTheme(theme === 'dark' ? 'light' : 'dark');
                  setIsMenuOpen(false);
                }}>
                  <div className="flex items-center gap-3 text-sm text-sage-500 dark:text-gray-300">
                    {theme === 'dark' ? (
                ...
                */}
                ...
                {showEndSession && (
                  <>
                    {/* Separator */}
                    <div className="border-t border-sage-400 dark:border-gray-700 my-1" />
