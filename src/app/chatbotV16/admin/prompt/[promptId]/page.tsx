...
const PROMPT_CONFIGS = {
  profile_merge_system: {
    ...
    description: 'System prompt for merging user profile data from conversation analysis',
    category: 'profile_merge_system'
  },
  profile_merge_user: {
    name: 'Profile Merge User Prompt',
    description: 'User prompt for merging user profile data from conversation analysis',
...
export default function SinglePromptPage() {
  ...
  }, [userId, promptConfig, loadCurrentPromptIntoEditor]);
  ...
  }, [userId, promptConfig, loadCurrentPrompt]);
