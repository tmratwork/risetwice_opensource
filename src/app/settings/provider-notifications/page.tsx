// src/app/settings/provider-notifications/page.tsx
"use client";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                Get notified when patients interact with your AI Preview or reply to your messages
              </p>

              {/* Link to Patient Notification Settings */}
              <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
                  Also a patient? Manage your patient notification preferences separately.
                </p>
                <a
                  href="/settings/notifications"
                  className="inline-flex items-center text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
                >
                  Go to Patient Notification Settings
                  <svg
              ...
              <label className="flex items-start space-x-3 mb-4 cursor-pointer group">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Receive email alerts when patients use your AI Preview or reply to your messages
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-start space-x-3 mb-4 cursor-pointer group">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Receive text alerts when patients use your AI Preview or reply to your messages
                  </p>
                </div>
              </label>
