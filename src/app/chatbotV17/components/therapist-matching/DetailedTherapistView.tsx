                ...
                <div className="mt-6 space-y-3">
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                      ...
                      className="font-bold px-6 sm:px-8 py-3 rounded-lg transition-colors hover:opacity-80 text-base sm:text-lg disabled:opacity-50 w-full sm:w-auto whitespace-nowrap"
                      style={{
                    ...
                    <button
                      ...
                      className="font-bold px-6 sm:px-8 py-3 rounded-lg transition-colors hover:opacity-80 text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto whitespace-nowrap"
                      style={{
